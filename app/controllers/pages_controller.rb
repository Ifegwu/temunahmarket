class PagesController < ApplicationController
    ...
    def plans
      # @plans = Stripe::Plan.list(product: "prod_GRWehRUQMTKWu2")
      @plans = Stripe::Plan.list(product: Rails.application.credentials[Rails.env.to_sym][:stripe][:SUBSCRIPTION_PLAN_ID])
    end
end